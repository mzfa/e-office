...
class HakAksesController extends Controller
{
    public function index()
    {
        ...
        $struktur = DB::table('struktur')->whereNull('deleted_at')->get();
        return view('hakakses.index', compact('data','struktur'));
    }
    ...
    public function edit($id)
    {
        ...
        // }
        // return $text;
        return view('modal_content.hak_akses', compact('data','struktur'));
    }
