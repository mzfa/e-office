                        ...
                        <tbody>
                            <div id="tableData">
                                ...
                                <tr>
                                    ...
                                    {{-- <td class="mailbox-date"><a onclick="return confirm('Apakah kamu yakin pesan ini ingin diaktifkan')" href="{{ url('message/aktifkan/'.Crypt::encrypt($surat->surat_id)) }}" class="btn btn-primary">Aktifkan</a></td> --}}
                                </tr>
                                @endforeach
                            </div>
                        </tbody>
